...
const About = () => {
  return (
    <section id="about" className="bg-[#dadada] py-16 px-6 md:px-12 lg:px-20">
      <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
        ...
        <motion.div
          ...
          transition={{ duration: 0.8 }}
        >
          <h2 className="text-3xl md:text-4xl font-bold text-[#000A26] mb-4">
            Conheça a Digital Boost
          </h2>
          <h3 className="text-xl font-semibold text-[#FEBD00] mb-4">
          ...
          <button className="inline-block cursor-pointer bg-[#000A26] text-white font-semibold px-6 py-3 rounded-lg shadow-md transition duration-300 hover:scale-105 hover:bg-[#0142FF]">
            Vamos conversar?
          </button>
        </motion.div>
      </div>
      ...
      <div className="mt-12 grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        >
          <FaAward className="text-3xl mb-4 text-[#000A26] mx-auto" />
          <h4 className="text-xl font-semibold mb-2">EXPERIÊNCIA</h4>
          <p className="text-sm text-[#000a26]">
        ...
        >
          <FaProjectDiagram className="text-3xl mb-4 text-[#FEBD00] mx-auto" />
          <h4 className="text-lg font-semibold mb-2">PROJETOS ENTREGUES</h4>
          <p className="text-sm text-[#FEBD00]">
        ...
        <motion.div
          ...
          className="bg-[#FEBD00] p-6 rounded-lg text-center text-white shadow-md hover:shadow-xl transition-shadow duration-300 border-2 border-[#000A26]"
        >
          <FaHandshake className="text-3xl mb-4 text-[#000A26] mx-auto" />
          <h4 className="text-lg font-semibold mb-2">EMPRESAS FIDELIZADAS</h4>
          <p className="text-sm text-[#000a26]">
