  ...
  return (
    <header className="shadow-md">
      <div className="mx-auto flex max-w-7xl items-center justify-between px-4 py-4 sm:px-8">
        ...
        <Link
          to="/"
          className="hidden items-center rounded-full border border-gray-300 px-4 py-2 pl-6 shadow-md lg:flex"
        >
        ...
        <Link
          to="/login"
          className="flex items-center gap-2 rounded-full border border-gray-300 px-4 py-2 pl-6 shadow-md"
        >
          <svg
            xmlns="http://www.w3.org/2000/svg"
            viewBox="0 0 24 24"
          ...
          <p className="max-w-20 truncate sm:max-w-32">Giovanni Felipe</p>
        </Link>
      </div>
    </header>
  );
