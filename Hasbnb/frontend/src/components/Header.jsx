    ...
    return (
        <header className='shadow-md'>
            ...
            <div className='flex items-center justify-between px-4 sm:px-8 py-4 max-w-7xl mx-auto'>
                ...
                <Link to='/' className=' hidden  lg:flex items-center border border-gray-300 px-4 pl-6 py-2 rounded-full shadow-md'>

                    <p className='border-r pr-4 border-r-gray-300'>Qualquer lugar</p>
                    <p className='border-r px-4 border-r-gray-300'>Qualquer Semana</p>
                ...
                <Link to='/login' className='flex items-center border border-gray-300 px-4 pl-6 py-2 rounded-full shadow-md gap-2'>
                    ...
                    <p className='sm:max-w-32 max-w-20 truncate'>Giovanni Felipe</p>
